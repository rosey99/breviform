...
def runBreveForm(cmds: Sequence[str], tfargs: Sequence[str], tfvars: Mapping[str, Any], tf_workdir: str) -> Mapping:
    """
    4 required args:
    cmds: sequence of 'tf_init', tf_plan, etc.
      these are BreviForm command methods
    tfargs: terraform command line arguments, 
      probably defined in the upstream wf definition
